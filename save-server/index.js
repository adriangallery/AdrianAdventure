...
app.use('*', cors({
  origin: ['https://adventure.zerothetoken.com', 'https://adventure.adrianzero.com', 'https://zeroadventure.vercel.app', 'https://adrianzero.com', 'http://localhost:3000', 'http://localhost:5173'],
